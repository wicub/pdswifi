...
<script type="text/javascript" src="http://www.wyywifi.com/UI/Public/js/jquery.js"></script>
...
<div class="tips" id="tips"></div>
 <label class="lb_title mr-tb-5" >第一步:&nbsp;&nbsp;关注微信号:&nbsp;&nbsp;<?php echo ($wxname); ?></br></br>第二步:&nbsp;&nbsp;点击"一键上网"<br><font style="font-size:12px;color:red;">(如果没有请发送"上网"即可)</font></label>
<div class="">
</div>
...
<a  class="btn_base corner-all-10 t-wh c-wifiadv uba mr-tb-10" href="http://weixin.qq.com/r/bHV9ZRzEoEHfrVgG9yB_" id="btn_reg">打开微信关注</a>
<p style="text-align:center" id="wolegequ">仅限苹果手机点击可以打开微信,安卓请自己打开微信,请先复制微信号</p>
