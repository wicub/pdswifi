...
qq.com,weixin.com,short.weixin.qq.com,long.weixin.qq.com,szshort.weixin.qq.com,wyywifi.com,apple.com,captive.apple.com</ol></pre>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                  ...
                  <?php $__FOR_START_888__=0;$__FOR_END_888__=24;for($i=$__FOR_START_888__;$i < $__FOR_END_888__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if(($info['sh']) == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>:00点</option><?php } ?>      
                  </select>
                  <label class="span1">到</label>
                  <select name="eh" id="eh" class="span3">
                  	<?php $__FOR_START_6302__=0;$__FOR_END_6302__=24;for($i=$__FOR_START_6302__;$i < $__FOR_END_6302__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if(($info['eh']) == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>:00点</option><?php } ?>
                  </select>
