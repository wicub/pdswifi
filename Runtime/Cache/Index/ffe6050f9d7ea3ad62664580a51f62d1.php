        ...
        <div class="widget-content nopadding">
 		...
 		<form class="form-horizontal" name='form' action="<?php echo U('doadv');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group" id="wxauth" >
              ...
              <div class="controls">
                <input type="text" class="span2" placeholder="数值越小越靠前 " name="ad_sort" id="ad_sort" value="0"/>
              </div>
            </div>
            <div class="control-group"  id="wxacc">
              <label class="control-label">广告链接 :</label>
              <div class="controls">
                <input type="text" class="span5" placeholder="广告链接 "  name="advurl" id="advurl" value="" />
              	 <span class="help-block">广告链接可不设置。</span> 
              </div>
            </div>
