  ...
  <div class="row-fluid">
    <div class="span8">
      <div class="widget-box">
        ...
        <form action="<?php echo U('index/web/addarts');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
 <div class="control-group">
              <label class="control-label">所属栏目 :</label>
              <div class="controls">
               	<select name="cid" id="cid">
               	<option value="-1>">请选择文章所属栏目</option>
               		<?php if(is_array($catelog)): $i = 0; $__LIST__ = $catelog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="文章标题 "  name="title" id="title" value="" />
              </div>
            </div>
           <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<textarea name="desc" id="desc" class="span11"></textarea>  
              </div>
            </div>
             ...
             <div class="control-group">
	              ...
	              <div class="controls">
	              	<input type="checkbox" name="topflag" value="1"/>
	 						              </div>
	        </div>
